...
//Styles
const textStyle = "border p-2 rounded font-semibold sm:text-2xl md:text-3xl text-center hover:text-[#8da9c4] w-full max-w-96 h-36 flex flex-col justify-center gap-2";
